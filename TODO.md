...
- [🔴] A swarmforge.conf role configured with backend `deepseek` passes config validation instead of being rejected with "Unsupported agent", since `known-agents` was never updated to include it.
